...
Users.belongsToMany(Project, { through: UserAssignProject, foreignKey: "userId",as: 'ProjectAssignUser' });
Project.belongsToMany(Users, { through: UserAssignProject, foreignKey: "projectId",as: 'UserAssignProject' });
...
// 			password: "$2a$10$2uzRqhRWKNPPLrinAYONbegGrOcLKMaaXmEGXIMgUzVTw/4.W2BN6",
// 			name: "Bằng Đẹp trai",
